/**
 * A basic workout for lower body exercises
 *
 * @component BasicLowerBodyWorkout
 * @version 1.0.0
...
import DeadLift from '../../../Pictures/DeadLift.jpg'
...
const BasicLowerBodyWorkout: React.FC = () => {
  const {
    workoutStarted,
    isPaused,
    isResting,
...
export default BasicLowerBodyWorkout
